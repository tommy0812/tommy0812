...
def json_transform_xml(json_path, xml_path, process_mode="polygon"):
    ...
    for xmin, ymin, xmax, ymax, label, segmentation_list in coordis:
        xml_anno.add_object(name_text_str=str(label),
                            ...
                            seg_text_str = str(segmentation_list)
                            )
...
if __name__ == "__main__":
    # root_json_dir = r"D:\Anaconda_env/NEW/tri/trisdnet_train"  # json的路径
    # root_save_xml_dir = r"D:\Anaconda_env/NEW/tri/xml_train"  # xml的保存路径
    root_json_dir = r"/media/jason/9400F87F00F8699E/Tommy_TriSDNet/c2l_train"  # json的路径
    root_save_xml_dir = r"/media/jason/9400F87F00F8699E/Tommy_TriSDNet/c2l_train_xml"  # xml的保存路径
